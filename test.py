...
def testLifeCycle():
    ...
    assert (
        new_animal1 in new_caretaker1.animals
        and new_animal2 in new_caretaker1.animals
        and new_animal3 in new_caretaker2.animals
        and new_animal4 in new_caretaker2.animals
        and new_animal5 in new_caretaker2.animals
        and new_animal6 in new_caretaker3.animals
        and new_animal7 in new_caretaker3.animals
        and new_animal8 in new_caretaker3.animals
        and new_animal9 in new_caretaker3.animals
        and new_animal10 in new_caretaker3.animals
    )
    assert (
        new_animal1.care_taker == new_caretaker1
        and new_animal2.care_taker == new_caretaker1
        and new_animal3.care_taker == new_caretaker2
    )
    ...
    assert (
        new_enclosure1 in new_zoo.all_Enclosures
        and new_enclosure2 in new_zoo.all_Enclosures
        and new_enclosure2 in new_zoo.all_Enclosures
    )
    ...
    assert (
        len(new_animal1.medical_checkup) == 1
        and len(new_animal2.medical_checkup) == 1
        and len(new_animal3.medical_checkup) == 1
        and len(new_animal4.medical_checkup) == 1
    )
    ...
    assert (
        len(new_animal11.feeding_record) == 1
        and len(new_animal12.feeding_record) == 1
        and len(new_animal13.feeding_record) == 1
    )
    ...
    assert (
        len(new_enclosure1.cleaning_records) == 1
        and len(new_enclosure2.cleaning_records) == 2
        and len(new_enclosure3.cleaning_records) == 3
    )
